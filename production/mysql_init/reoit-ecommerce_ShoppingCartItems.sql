...
CREATE TABLE `ShoppingCartItems` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_tag` (`cartId`,`productItemId`),
  KEY `productItemId` (`productItemId`),
  CONSTRAINT `shoppingcartitems_ibfk_1` FOREIGN KEY (`cartId`) REFERENCES `shoppingCarts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `shoppingcartitems_ibfk_2` FOREIGN KEY (`productItemId`) REFERENCES `productItems` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
